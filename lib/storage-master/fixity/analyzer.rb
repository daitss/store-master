  ...
  class PoolVsDaitssAnalyzer
    ...
    def run
      ...
      (@pool_fixity_stream <=> @daitss_fixity_stream).each do |url, pool_data, daitss_data|
        ...
        # for example
        #
        # url:          http://storage-master.fcla.edu/packages/EYMZSFV43_8A2KCD.000
        ...
        # daitss_data:  #<struct ieid="E101W4TQQ_VGD9QW", url="http://storage-master.fda.fcla.edu:70/packages/E101W4TQQ_VGD9QW.000", last_successful_fixity_time="2011-10-02T03:38:38Z", package_store_time="2011-09-19T18:19:52Z", md5="f1b797725b64c4a06a81bcfac0c1f077", sha1="1a6f80fd868cda45e6f8413f8fc9dbd9c081f3f9", size=9256960>
